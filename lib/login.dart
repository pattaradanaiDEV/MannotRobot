...
class _LoginPageState extends State<LoginPage> {
  ...
  Future<void> _login() async {
    try {
      ...
      // ถ้าสำเร็จ ให้ย้ายไปหน้า Home (สมมติว่าชื่อ HomePage)
      // Navigator.pushReplacementNamed(context, '/home');
      print("Login Success!");
    } on FirebaseAuthException catch (e) {
      // ถ้าพลาด ให้โชว์ Error บอกผู้ใช้
          ...
          child: Padding(
            ...
            child: Column(
              children: [
                ...
                // Input Fields
                _buildTextField(label: 'Email or Username', hint: '', icon: Icons.person_outline, controller: _emailController),
                const SizedBox(height: 20),
                _buildTextField(label: 'Password', hint: '', icon: Icons.lock_outline, isPassword: true, controller: _passwordController),
                ...
                OutlinedButton.icon(
                  onPressed: () {},
                  icon: const Icon(Icons.g_mobiledata, size: 30), // หรือใช้รูป Logo Google
    ...
    Widget _buildTextField({required String label, required String hint, required IconData icon, required TextEditingController controller, bool isPassword = false}) {
      return Column(
